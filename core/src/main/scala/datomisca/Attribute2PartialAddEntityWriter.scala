...
object Attribute2PartialAddEntityWriter {
  ...
  /** If there is a conversion to `DD` from `T`
    ...
    */
  implicit def oneValue[DD <: AnyRef, Card <: Cardinality, T](implicit conv: ToDatomic[DD, T]): Attribute2PartialAddEntityWriter[DD, Card, T] =
    new Attribute2PartialAddEntityWriter[DD, Card, T] {
      override def convert(attr: Attribute[DD, Card]): PartialAddEntityWriter[T] = new PartialAddEntityWriter[T] {
  ...
  /** If there is a conversion to `DD` from `T`
    * (see [[ToDatomic]]) and `Coll` is a iterable of `T`,
    ...
    */
  implicit def manyValues[DD <: AnyRef, Coll, T](implicit ev: Coll <:< Iterable[T], conv: ToDatomic[DD, T]): Attribute2PartialAddEntityWriter[DD, Cardinality.many.type, Coll] =
    new Attribute2PartialAddEntityWriter[DD, Cardinality.many.type, Coll] {
      override def convert(attr: Attribute[DD, Cardinality.many.type]): PartialAddEntityWriter[Coll] = new PartialAddEntityWriter[Coll] {
        override def write(c: Coll): PartialAddEntity =
          if (c.isEmpty)
  ...
  /** If a value of type `T` can be used as a reference value
    ...
    */
  implicit def oneRef[Card <: Cardinality, T](implicit ev: AsDatomicRef[T]): Attribute2PartialAddEntityWriter[DatomicRef.type, Card, T] =
    new Attribute2PartialAddEntityWriter[DatomicRef.type, Card, T] {
      override def convert(attr: Attribute[DatomicRef.type, Card]): PartialAddEntityWriter[T] = new PartialAddEntityWriter[T] {
  ...
  /** If a value of type `T` can be used as a reference value
    * (see [[AsDatomicRef]]) and `Coll` is a iterable of `T`,
    * then we can write a value of type `Coll`
    * as a list of entity ids for a cardinality many reference attribute.
    */
  implicit def manyRefs[Coll, T](implicit ev: Coll <:< Iterable[T], conv: AsDatomicRef[T]): Attribute2PartialAddEntityWriter[DatomicRef.type, Cardinality.many.type, Coll] =
    new Attribute2PartialAddEntityWriter[DatomicRef.type, Cardinality.many.type, Coll] {
      override def convert(attr: Attribute[DatomicRef.type, Cardinality.many.type]): PartialAddEntityWriter[Coll] = new PartialAddEntityWriter[Coll] {
        override def write(c: Coll): PartialAddEntity =
          if (c.isEmpty)
            PartialAddEntity.empty
          else {
  ...
  /** If a value of type `T` is a subtype of [[IdView]]
    ...
    * as an entity id reference for a reference attribute.
    */
  implicit def oneIdView[Card <: Cardinality, V, T](implicit witness: V <:< IdView[T]): Attribute2PartialAddEntityWriter[DatomicRef.type, Card, V] =
    new Attribute2PartialAddEntityWriter[DatomicRef.type, Card, V] {
      override def convert(attr: Attribute[DatomicRef.type, Card]): PartialAddEntityWriter[V] = new PartialAddEntityWriter[V] {
  ...
  /** If a value of type `T` is a subtype of [[IdView]]
    * and `Coll` is a iterable of `IdView[T]`,
    * then we can write a value of type `Coll`
    * as a list of entity ids for a cardinality many reference attribute.
    */
  implicit def manyIdViews[Coll, T](implicit witness: Coll <:< Iterable[IdView[T]]): Attribute2PartialAddEntityWriter[DatomicRef.type, Cardinality.many.type, Coll] =
    new Attribute2PartialAddEntityWriter[DatomicRef.type, Cardinality.many.type, Coll] {
      override def convert(attr: Attribute[DatomicRef.type, Cardinality.many.type]): PartialAddEntityWriter[Coll] = new PartialAddEntityWriter[Coll] {
        override def write(c: Coll): PartialAddEntity =
          if (c.isEmpty)
